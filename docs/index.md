...
Starting with Amazon S3 Encryption Client for .NET V4, you can encrypt objects with AES-GCM with key commitment, which protects your data against key substitution attacks.
...
For more information, see see [S3 Encryption Client Migration (V2 to V4)](https://docs.aws.amazon.com/sdk-for-net/v4/developer-guide/s3-encryption-migration-v2-v4.html).
