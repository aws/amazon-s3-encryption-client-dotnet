...
namespace Amazon.Extensions.S3.Encryption.IntegrationTests
{
    public class EncryptionTestsV2 : TestBase<AmazonS3Client>
    {
        ...
        //             () =>
        //             {
        //                 EncryptionTestsUtils.TestPutGet(s3EncryptionClientMetadataModeKMS, pathToLargeFile, null,
        //                     null, null, bucketName);
        //             },
        //             typeof(AmazonCryptoException), AesGcmLimitError);
        //     }
        //     finally
        //     {
        ...
        public void PutGetFileUsingMetadataModeSymmetricWrap()
        {
            ...
            EncryptionTestsUtils.ValidateMetaDataIsReturnedAsIs(vanillaS3Client, s3EncryptionClientMetadataModeSymmetricWrap, key, bucketName, 2);
        }
        ...
        public void PutGetFileUsingMetadataModeAsymmetricWrap()
        {
            ...
            EncryptionTestsUtils.TestPutGet(s3EncryptionClientMetadataModeAsymmetricWrap, filePath, null, null,
                SampleContent, bucketName, key);
            EncryptionTestsUtils.ValidateMetaData(vanillaS3Client, key, bucketName, 2);
            EncryptionTestsUtils.ValidateMetaDataIsReturnedAsIs(vanillaS3Client, s3EncryptionClientMetadataModeAsymmetricWrap, key, bucketName, 2);
            EncryptionTestsUtils.ValidateRsaEnvelopeKeyFormat(vanillaS3Client, key, bucketName, rsa);
        }
        ...
        public void PutGetFileUsingInstructionFileModeSymmetricWrap()
        {
            ...
            EncryptionTestsUtils.TestPutGet(s3EncryptionClientFileModeSymmetricWrap, filePath, null, null,
                SampleContent, bucketName, key);
            EncryptionTestsUtils.ValidateInstructionFile(vanillaS3Client, key, bucketName, 2);
        }
        ...
        public void PutGetFileUsingInstructionFileModeAsymmetricWrap()
        {
            ...
            EncryptionTestsUtils.TestPutGet(s3EncryptionClientFileModeAsymmetricWrap, filePath, null, null,
                SampleContent, bucketName, key);
            EncryptionTestsUtils.ValidateInstructionFile(vanillaS3Client, key, bucketName, 2);
            EncryptionTestsUtils.ValidateRsaEnvelopeKeyFormat(vanillaS3Client, key, bucketName, rsa, true);
        }
        ...
        {
            var key = $"key-{Guid.NewGuid()}";
            EncryptionTestsUtils.MultipartEncryptionTest(s3EncryptionClientMetadataModeAsymmetricWrap, bucketName, key);
            EncryptionTestsUtils.ValidateRsaEnvelopeKeyFormat(vanillaS3Client, key, bucketName, rsa);
        }
        ...
        {
            var key = $"key-{Guid.NewGuid()}";
            EncryptionTestsUtils.MultipartEncryptionTest(s3EncryptionClientFileModeAsymmetricWrap, bucketName, key);
            EncryptionTestsUtils.ValidateRsaEnvelopeKeyFormat(vanillaS3Client, key, bucketName, rsa, true);
        }
