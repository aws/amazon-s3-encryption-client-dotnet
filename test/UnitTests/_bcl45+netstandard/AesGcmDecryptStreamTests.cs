...
namespace Amazon.Extensions.S3.Encryption.UnitTests
{
    ...
    public class AesGcmDecryptStreamTests
    {
        ...
        [TestCategory("Core")]
        [DataTestMethod]
        [DataRow("DA2FDB0CED551AEB723D8AC1A267CEF3", 
            "",
        ...
        [DataRow("4194935CF4524DF93D62FEDBC818D8AC", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D",
        ...
        [DataRow("AD03EE2FD6048DB7158CEC55D3D760BC", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D", 
            "",
        ...
        [DataRow("20142E898CD2FD980FBF34DE6BC85C14DA7D57BD28F4AA5CF1728AB64E843142", 
            "", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D",
            "FB7B4A824E82DAA6C8BC1251", 
            "",
            "81C0E42BB195E262CB3B3A74A0DAE1C8")]
        [DataRow("D211F278A44EAB666B1021F4B4F60BA6B74464FA9CB7B134934D7891E1479169", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D",
        ...
        [DataRow("CFE8BFE61B89AF53D2BECE744D27B78C9E4D74D028CE88ED10A422285B1201C9", 
            "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D", 
            "",
        ...
        public void Decrypt(string key, string expectedPlainText,  string aad, string nonce, string cipherText, string tag)
        {
            ...
            foreach (var readCount in ReadCounts)
            {
                ...
                // Final assert
                Assert.AreEqual(expectedPlainText, decryptedPlainText);
            }
        }
