...
namespace Amazon.Extensions.S3.Encryption.UnitTests
{
    ...
    public class AesGcmDecryptStreamTests
    {
        ...
        public void Decrypt()
        {
            ...
            {
                var key = line[0];
                var expectedPlainText = line[1];
                var aad = line[2];
                var nonce = line[3];
                var cipherText = line[4];
                var tag = line[5];
        ...
        [Fact]
        public void EncryptDecryptWithModification()
        {
            const string failedToDecryptMessage = "Failed to decrypt: mac check in GCM failed";
            const string key = "4194935CF4524DF93D62FEDBC818D8AC";
            const string aad = "167B5C226177733A782D616D7A2D63656B2D616C675C223A205C224145532F47434D2F4E6F50616464696E675C227D";
            const string nonce = "0C5A8F5AF7F6064C0130EE64";
            const string cipherText = "3F4CC9A7451717E5E939D294A1362B32C274D06411188DAD76AEE3EE4DA46483EA4C1AF38B9B74D7AD2FD8E310CF82";
            const string tag = "AD563FD10E1EFA3F26753F46E09DB3A0";
            ...
            Assert.Equal(failedToDecryptMessage, exception.Message);
            ...
            exception = Assert.Throws<AmazonCryptoException>(() =>
            {
