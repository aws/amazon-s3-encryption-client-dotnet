...
namespace Amazon.Extensions.S3.Encryption
{
    ...
    internal static partial class EncryptionUtils
    {
        ...
        internal static void EnsureSupportedAlgorithmsV3(MetadataCollection metadata, JsonData instructionFilePairs = null)
        {
            ...
            var encryptedDataKeyAlgorithm = instructionFilePairs == null
                ...
                : StringValue(instructionFilePairs, ContentMetaDataV3Utils.EncryptedDataKeyAlgorithmV3);
        ...
        /// </returns>
        internal static EncryptionInstructions BuildInstructionsForNonKmsV3InInstructionMode(MetadataCollection objectMetaData, JsonData pairsFromInsFile, EncryptionMaterialsBase materials)
        {
            //= ../specification/s3-encryption/data-format/metadata-strategy.md#object-metadata
            //= type=exception
            //# The S3EC SHOULD support decoding the S3 Server's "double encoding".
            ...
            if (objectMetaData[ContentMetaDataV3Utils.MatDescV3] != null)
                ...
                materialDescription = JsonMapper.ToObject<Dictionary<string, string>>((string)pairsFromInsFile[ContentMetaDataV3Utils.MatDescV3]);
            else 
                //= ../specification/s3-encryption/data-format/content-metadata.md#v3-only
                //= type=implication
            ...
            {
                encryptionContext = JsonMapper.ToObject<Dictionary<string, string>>((string)pairsFromInsFile[ContentMetaDataV3Utils.EncryptionContextV3]);
            }
            else
            {
        ...
        internal static Dictionary<string, string> GetEncryptionContextFromMetaData(MetadataCollection metadata)
        {
            ...
            var ec = JsonMapper.ToObject<Dictionary<string, string>>(ecJsonString);
            return ec;
        }
