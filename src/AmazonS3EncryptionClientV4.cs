...
namespace Amazon.Extensions.S3.Encryption
{
    ...
    /// AES/GCM with key commitment - Encryption and Decryption
    ///	AES/GCM - Encryption and Decryption
    ///	AES/CBC - Decryption only
    /// </summary>
    public partial class AmazonS3EncryptionClientV4 : AmazonS3EncryptionClientBase
    {
        private static readonly string _assemblyVersion = Assembly.GetExecutingAssembly().GetName().Version?.ToString() ?? string.Empty;
        private static readonly string _userAgentString = $"lib/amazon-extensions-s3-encryption#{_assemblyVersion} ft/S3CryptoV4";

        ///<inheritdoc/>
        public AmazonS3EncryptionClientV4(AmazonS3CryptoConfigurationV4 config, EncryptionMaterialsV4 materials) 
            : base(config, materials)
        {
        }

        ///<inheritdoc/>
        public AmazonS3EncryptionClientV4(AWSCredentials credentials, AmazonS3CryptoConfigurationV4 config, EncryptionMaterialsV4 materials) 
            : base(credentials, config, materials)
        {
        }

        ///<inheritdoc/>
        public AmazonS3EncryptionClientV4(string awsAccessKeyId, string awsSecretAccessKey, AmazonS3CryptoConfigurationV4 config, EncryptionMaterialsV4 materials) 
            : base(awsAccessKeyId, awsSecretAccessKey, config, materials)
        {
        }

        ///<inheritdoc/>
        public AmazonS3EncryptionClientV4(string awsAccessKeyId, string awsSecretAccessKey, string awsSessionToken, AmazonS3CryptoConfigurationV4 config, EncryptionMaterialsV4 materials)
        ...
        protected override void CustomizeRuntimePipeline(RuntimePipeline pipeline)
        {
            ...
            pipeline.AddHandlerBefore<Amazon.Runtime.Internal.Marshaller>(new SetupEncryptionHandlerV4(this));
            pipeline.AddHandlerAfter<Amazon.Runtime.Internal.Marshaller>(new UserAgentHandler(_userAgentString));
            pipeline.AddHandlerBefore<Amazon.S3.Internal.AmazonS3ResponseHandler>(new SetupDecryptionHandlerV4(this));
        }
